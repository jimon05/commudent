        ...
        <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8">
          <header className="mb-5 flex flex-col gap-4 border-b border-line pb-5 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h1 className="mt-3 text-3xl font-black tracking-normal text-ink sm:text-4xl">핵심 내용 전달 연습</h1>
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
                발표 자료와 대본에서 핵심 내용을 잡고, 슬라이드별 전달 여부와 전체 발표 목표를 기준으로 연습합니다.
              </p>
            </div>
            <Link
          ...
          <Suspense fallback={<div className="rounded-lg border border-line bg-white p-5 text-sm font-bold text-slate-500">녹음 화면을 준비하는 중입니다.</div>}>
            <Recorder />
          </Suspense>
        </div>
      </main>
